...
[![Quality Gate](https://sonarcloud.io/api/badges/gate?key=jstemerdink:EPi.Libraries.Localization)](https://sonarcloud.io/dashboard?id=jstemerdink%3AEPi.Libraries.Localization)
...
Don't forget to add a '''localization.azure.subscriptionkey''' to the appsettings. 
