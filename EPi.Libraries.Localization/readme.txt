...
If you want to use a service to translate automatically, you need to inject on. You can use either the Azure provider I created in EPi.Libraries.Localization.Azure. 
